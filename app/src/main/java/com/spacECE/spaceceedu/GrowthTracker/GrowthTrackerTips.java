    ...
    public class    GrowthTrackerTips extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            ImageView imageView = findViewById(R.id.growth_tracker_tips_image);
            ...
            if (Category != null) {
                switch (Category) {
                    ...
                    case "Outdoor Play":
                        ...
                        imageView.setImageResource(R.drawable.outdoor_play);
                        break;
                    ...
                    case "Sleep Time":
                        ...
                        imageView.setImageResource(R.drawable.sleep_time);
                        break;
                    ...
                    case "Screen Time":
                        ...
                        imageView.setImageResource(R.drawable.screen_time);
                        break;
