...
public class AgoraaLogger extends RecyclerView {
    ...
    public AgoraaLogger(@NonNull Context context) {
        super(context);
        init(context);
    }

    public AgoraaLogger(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AgoraaLogger(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
